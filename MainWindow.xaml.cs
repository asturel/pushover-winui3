...
public sealed partial class MainWindow : Window
{
    ...
    // Parameterless ctor required by XAML — resolve services from App.Instance (IHost) for DI
    public MainWindow()
    {
        this.InitializeComponent();

        // Resolve from host
        _services = App.Instance.Services;
        _storage = _services.GetRequiredService<IMessageStorage>();
